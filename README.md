...
Сервис отвечает за управление пользователями и выпуск JWT-токенов. Auth Service отвечает исключительно за управление пользователями и выпуск JWT-токенов и может быть использован любыми внешними клиентами без привязки к Telegram-боту.
